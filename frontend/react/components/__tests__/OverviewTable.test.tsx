...
function makeWorklog(seconds: number): EnrichedJiraWorklog {
	return {
...
const sarah: Entry = [
	'Sarah Johnson',
	{
		'2026-05-01': [makeWorklog(3600 * 5)],
		'2026-05-02': [makeWorklog(3600 * 3)],
	},
];
const alex: Entry = ['Alex Doe', { '2026-05-01': [makeWorklog(3600 * 4)] }];
